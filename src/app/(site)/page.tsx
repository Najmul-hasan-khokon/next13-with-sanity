...
export default async function Home() {
   ...
   return (
      <div>
         <h1 className="text-6xl font-extrabol">
            Hello I&apos;m
            ...
            {projects.map((project) => (
               ...
               >
                  <div className="border-2 border-gray-500 rounded-lg p-1">
                     ...
                     <h1 className="mt-2 font-extrabold bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent">
                        {project.name}
                     </h1>
                  </div>
               </Link>
